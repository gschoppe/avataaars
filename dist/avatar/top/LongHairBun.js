...
var LongHairBun = /** @class */ (function (_super) {
    ...
    LongHairBun.prototype.render = function () {
        ...
        return (React.createElement("g", { id: "".concat(this.props.uid, "-Top"), strokeWidth: '1', fillRule: 'evenodd' },
            ...
            React.createElement("g", { id: "".concat(this.props.uid, "-Top/Long-Hair/Bun"), mask: "url(#".concat(mask1, ")") },
                React.createElement("g", { transform: 'translate(-1.000000, 0.000000)' },
                    ...
                    React.createElement("use", { id: "".concat(this.props.uid, "-Short-Hair"), stroke: 'none', fill: '#28354B', fillRule: 'evenodd', xlinkHref: '#' + path1 }),

...
var Eyepatch = /** @class */ (function (_super) {
    ...
    Eyepatch.prototype.render = function () {
        var path1 = "".concat(this.props.uid, "-Eyepatch-Path");
        var mask1 = "".concat(this.props.uid, "-Eyepatch-Mask");

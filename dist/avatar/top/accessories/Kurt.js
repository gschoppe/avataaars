...
class Kurt extends React.Component {
    render() {
        const filter1 = `${this.props.uid}-accessories-filter1`;
        return (React.createElement("g", { id: `${this.props.uid}-Top/Accessories/Kurt`, fill: 'none', transform: 'translate(62.000000, 85.000000)', strokeWidth: '1' },
            ...
            React.createElement("g", { id: `${this.props.uid}-Kurts`, filter: `url(#${filter1})`, transform: 'translate(5.000000, 2.000000)' },

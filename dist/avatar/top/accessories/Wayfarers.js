...
class Wayfarers extends React.Component {
    render() {
        const path1 = `${this.props.uid}-accessories-path1`;
        const path2 = `${this.props.uid}-accessories-path2`;
        const filter1 = `${this.props.uid}-accessories-filter1`;
        const linearGradient1 = `${this.props.uid}-accessories-linearGradient1`;
        return (React.createElement("g", { id: `${this.props.uid}-Top/Accessories/Wayfarers`, fill: 'none', transform: 'translate(62.000000, 85.000000)', strokeWidth: '1' },
            ...
            React.createElement("g", { id: `${this.props.uid}-Wayfarers`, filter: `url(#${filter1})`, transform: 'translate(7.000000, 7.000000)' },
                React.createElement("g", { id: `${this.props.uid}-Shades`, transform: 'translate(10.795455, 2.928571)', fillRule: 'nonzero' },
                    React.createElement("g", { id: `${this.props.uid}-Shade-Left` },
                    ...
                    React.createElement("g", { id: `${this.props.uid}-Shade-Right` },

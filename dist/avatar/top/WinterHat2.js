...
class WinterHat2 extends React.Component {
    render() {
        ...
        return (React.createElement("g", { id: `${this.props.uid}-Top` },
            ...
            React.createElement("g", { id: `${this.props.uid}-Top/Accessories/Winter-Hat-2`, transform: 'translate(-1.000000, 0.000000)' },
                React.createElement("g", { id: `${this.props.uid}-Hat`, strokeWidth: '1', fillRule: 'evenodd', transform: 'translate(61.000000, 0.000000)' },
                    React.createElement("g", { id: `${this.props.uid}-Hat-String-Left`, transform: 'translate(0.000000, 176.000000)', fill: '#F4F4F4' },
                        React.createElement("circle", { id: `${this.props.uid}-Hat-Puff-Left`, cx: '9', cy: '65', r: '9' }),
                        React.createElement("rect", { x: '8', y: '0', width: '2', height: '58' })),
                    React.createElement("g", { id: `${this.props.uid}-Hat-String-Right`, transform: 'translate(126.000000, 168.000000)', fill: '#F4F4F4' },
                        React.createElement("circle", { id: `${this.props.uid}-Hat-Puff-Right`, cx: '9', cy: '65', r: '9' }),
                        React.createElement("rect", { x: '8', y: '0', width: '2', height: '58' })),
                    React.createElement("circle", { id: `${this.props.uid}-Hat-Puff-Top`, fill: '#F4F4F4', cx: '72', cy: '20', r: '20' }),
                    React.createElement("mask", { id: hatColorMask, fill: 'white' },
                        React.createElement("use", { xlinkHref: '#' + path1 })),
                    React.createElement("use", { id: `${this.props.uid}-Hat-Combined-Shape`, fill: '#F4F4F4', xlinkHref: '#' + path1 }),
                    React.createElement(HatColor, { uid: this.props.uid, defaultColor: 'Blue01' }),
                    React.createElement("rect", { id: 'color-dark', fillOpacity: '0.2', fill: '#000000', x: '-1', y: '21', width: '146', height: '46', mask: `url(#${hatColorMask})` }),
                    React.createElement("g", { id: `${this.props.uid}-Hat-Light-Triangles`, transform: 'translate(29.000000, 32.000000)', fill: '#FFFFFF', fillOpacity: '0.5' },
                        React.createElement("polygon", { id: `${this.props.uid}-Hat-Triangle1`, transform: 'translate(12.500000, 9.000000) rotate(180.000000) translate(-12.500000, -9.000000) ', points: '12.5 0 25 18 0 18' }),
                        React.createElement("polygon", { id: `${this.props.uid}-Hat-Triangle2`, transform: 'translate(43.500000, 9.000000) rotate(180.000000) translate(-43.500000, -9.000000) ', points: '43.5 0 56 18 31 18' }),
                        React.createElement("polygon", { id: `${this.props.uid}-Hat-Triangle3`, transform: 'translate(74.500000, 9.000000) rotate(180.000000) translate(-74.500000, -9.000000) ', points: '74.5 0 87 18 62 18' })),
                    React.createElement("g", { id: `${this.props.uid}-Hat-Dark-Triangles`, transform: 'translate(13.000000, 41.000000)', fill: '#000000', fillOpacity: '0.5' },
                        React.createElement("polygon", { id: `${this.props.uid}-Hat-Triangle4`, points: '12.5 0 25 18 0 18' }),
                        React.createElement("polygon", { id: `${this.props.uid}-Hat-Triangle5`, points: '43.5 0 56 18 31 18' }),
                        React.createElement("polygon", { id: `${this.props.uid}-Hat-Triangle6`, points: '74.5 0 87 18 62 18' }),
                        React.createElement("polygon", { id: `${this.props.uid}-Hat-Triangle7`, points: '105.5 0 118 18 93 18' }))),

...
var BeardLight = /** @class */ (function (_super) {
    ...
    BeardLight.prototype.render = function () {
        var path1 = "".concat(this.props.uid, "-Facial-Hair-path1");
        var facialHairMask = "".concat(this.props.uid, "-Facial-Hair-Mask");
        return (React.createElement("g", { id: "".concat(this.props.uid, "-Facial-Hair/Beard-Light"), transform: 'translate(49.000000, 72.000000)' },
            ...
            React.createElement("use", { id: "".concat(this.props.uid, "-Lite-Beard"), fill: '#331B0C', fillRule: 'evenodd', xlinkHref: '#' + path1 }),

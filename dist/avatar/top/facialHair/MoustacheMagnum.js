...
var MoustacheMagnum = /** @class */ (function (_super) {
    ...
    MoustacheMagnum.prototype.render = function () {
        var path1 = "".concat(this.props.uid, "-Facial-Hair-Path");
        var facialHairMask = "".concat(this.props.uid, "-Facial-Hair-Mask");
        return (React.createElement("g", { id: "".concat(this.props.uid, "-Facial-Hair/Moustache-Magnum"), transform: 'translate(49.000000, 72.000000)' },
            ...
            React.createElement("use", { id: "".concat(this.props.uid, "-Mustache"), fill: '#28354B', fillRule: 'evenodd', xlinkHref: '#' + path1 }),

...
var MoustacheFancy = /** @class */ (function (_super) {
    ...
    MoustacheFancy.prototype.render = function () {
        ...
        return (React.createElement("g", { id: "".concat(this.props.uid, "-Facial-Hair/Moustache-Fancy"), transform: 'translate(49.000000, 72.000000)' },
            ...
            React.createElement("use", { id: "".concat(this.props.uid, "-Moustache"), fill: '#28354B', fillRule: 'evenodd', xlinkHref: '#' + path1 }),

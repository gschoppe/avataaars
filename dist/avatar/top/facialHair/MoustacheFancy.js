...
class MoustacheFancy extends React.Component {
    render() {
        const path1 = `${this.props.uid}-Facial-Hair-Path`;
        const facialHairMask = `${this.props.uid}-Facial-Hair-Mask`;
        return (React.createElement("g", { id: `${this.props.uid}-Facial-Hair/Moustache-Fancy`, transform: 'translate(49.000000, 72.000000)' },
            ...
            React.createElement("use", { id: `${this.props.uid}-Moustache`, fill: '#28354B', fillRule: 'evenodd', xlinkHref: '#' + path1 }),

...
export default class FacialHairColor extends React.Component {
    render() {
        return (React.createElement(Selector, { option: FacialHairColorOption, defaultOption: 'BrownDark' }, Array.from(facialHairColorPalette.values()).map((ColorComponent, index) => (React.createElement(ColorComponent, { key: index, uid: this.props.uid })))));
    }
}

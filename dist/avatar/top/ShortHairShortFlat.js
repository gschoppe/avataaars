...
class ShortHairShortFlat extends React.Component {
    render() {
        ...
        return (React.createElement("g", { id: `${this.props.uid}-Top`, strokeWidth: '1', fillRule: 'evenodd' },
            ...
            React.createElement("g", { id: `${this.props.uid}-Top/Short-Hair/Short-Flat`, mask: `url(#${mask1})` },
                React.createElement("g", { transform: 'translate(-1.000000, 0.000000)' },
                    React.createElement(FacialHair, { uid: this.props.uid }),
                    React.createElement("mask", { id: hairColorMask, fill: 'white' },
                        React.createElement("use", { xlinkHref: '#' + path1 })),
                    React.createElement("use", { id: `${this.props.uid}-Short-Hair`, stroke: 'none', fill: '#1F3140', fillRule: 'evenodd', xlinkHref: '#' + path1 }),

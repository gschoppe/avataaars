...
var ShortHairSides = /** @class */ (function (_super) {
    ...
    ShortHairSides.prototype.render = function () {
        ...
        return (React.createElement("g", { id: "".concat(this.props.uid, "-Top"), strokeWidth: '1', fillRule: 'evenodd' },
            ...
            React.createElement("g", { id: "".concat(this.props.uid, "-Top/Short-Hair/Sides"), mask: "url(#".concat(mask1, ")") },
                React.createElement("g", { transform: 'translate(-1.000000, 0.000000)' },
                    React.createElement(facialHair_1.default, { uid: this.props.uid }),
                    React.createElement("g", { id: "".concat(this.props.uid, "-Hair"), strokeWidth: '1', fillRule: 'evenodd', transform: 'translate(70.000000, 74.000000)' },
                        React.createElement("mask", { id: hairColorMask, fill: 'white' },
                            React.createElement("use", { xlinkHref: '#' + path3 })),
                        React.createElement("use", { id: "".concat(this.props.uid, "-Sides"), fill: '#9E7A7A', xlinkHref: '#' + path3 }),

...
var LongHairBob = /** @class */ (function (_super) {
    ...
    LongHairBob.prototype.render = function () {
        var path1 = "".concat(this.props.uid, "-Hair-Path-1");
        var path2 = "".concat(this.props.uid, "-Hair-Path-2");
        var mask1 = "".concat(this.props.uid, "-Hair-Mask-1");
        ...
        return (React.createElement("g", { id: "".concat(this.props.uid, "-Top"), strokeWidth: '1', fillRule: 'evenodd' },
            ...
            React.createElement("g", { id: "".concat(this.props.uid, "-Top/Long-Hair/Bob"), mask: "url(#".concat(mask1, ")") },
                React.createElement("g", { transform: 'translate(-1.000000, 0.000000)' },
                    React.createElement("g", { id: "".concat(this.props.uid, "-Hair"), strokeWidth: '1', fillRule: 'evenodd', transform: 'translate(39.000000, 19.000000)' },

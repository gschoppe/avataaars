...
class LongHairBob extends React.Component {
    render() {
        const path1 = `${this.props.uid}-Hair-Path-1`;
        const path2 = `${this.props.uid}-Hair-Path-2`;
        const mask1 = `${this.props.uid}-Hair-Mask-1`;
        ...
        return (React.createElement("g", { id: `${this.props.uid}-Top`, strokeWidth: '1', fillRule: 'evenodd' },
            ...
            React.createElement("g", { id: `${this.props.uid}-Top/Long-Hair/Bob`, mask: `url(#${mask1})` },
                React.createElement("g", { transform: 'translate(-1.000000, 0.000000)' },
                    React.createElement("g", { id: `${this.props.uid}-Hair`, strokeWidth: '1', fillRule: 'evenodd', transform: 'translate(39.000000, 19.000000)' },

...
var Hat = /** @class */ (function (_super) {
    ...
    Hat.prototype.render = function () {
        ...
        var mask2 = "".concat(this.props.uid, "-top-mask-3");
        ...
        return (React.createElement("g", { id: "".concat(this.props.uid, "-Top"), strokeWidth: '1', fillRule: 'evenodd' },
            ...
            React.createElement("g", { id: "".concat(this.props.uid, "-Top/Accesories/Hat"), mask: "url(#".concat(mask1, ")") },
                React.createElement("g", { transform: 'translate(-1.000000, 0.000000)' },
                    React.createElement("g", { id: "".concat(this.props.uid, "-Hat"), strokeWidth: '1', fillRule: 'evenodd', transform: 'translate(1.000000, 0.000000)' },
                        React.createElement("mask", { id: mask2, fill: 'white' },
                            React.createElement("use", { xlinkHref: '#' + path1 })),
                        React.createElement("g", { id: "".concat(this.props.uid, "-Mask-Hair") }),
                        ...
                        React.createElement("ellipse", { id: "".concat(this.props.uid, "-HatPart1"), fill: '#1F333C', mask: "url(#".concat(mask2, ")"), cx: '132', cy: '87.5', rx: '122', ry: '57.5' }),
                        React.createElement("ellipse", { id: "".concat(this.props.uid, "-HatPart2"), fill: '#15232A', mask: "url(#".concat(mask2, ")"), cx: '132', cy: '82', rx: '62', ry: '25' })),

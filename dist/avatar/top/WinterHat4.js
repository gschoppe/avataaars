...
class WinterHat4 extends React.Component {
    render() {
        ...
        return (React.createElement("g", { id: `${this.props.uid}-Top` },
            ...
            React.createElement("g", { id: `${this.props.uid}-Top/Accessories/Winter-Hat-4`, transform: 'translate(-1.000000, 0.000000)' },
                React.createElement("g", { id: `${this.props.uid}-hat`, strokeWidth: '1', fillRule: 'evenodd', transform: 'translate(65.000000, 4.000000)' },
                    React.createElement("mask", { id: hatColorMask, fill: 'white' },
                        React.createElement("use", { xlinkHref: '#' + path1 })),
                    React.createElement("use", { id: `${this.props.uid}-hat-mask`, fill: '#D8D8D8', xlinkHref: '#' + path1 }),
                    React.createElement(HatColor, { uid: this.props.uid, defaultColor: 'Red' }),
                    React.createElement("mask", { id: hatColorMask, fill: 'white' },
                        React.createElement("use", { xlinkHref: '#' + path2 })),
                    React.createElement("use", { id: `${this.props.uid}-shadow`, fillOpacity: '0.24', fill: '#000000', xlinkHref: '#' + path2 }),
                    React.createElement("mask", { id: mask2, fill: 'white' },
                        React.createElement("use", { xlinkHref: '#' + path3 })),
                    React.createElement("use", { id: `${this.props.uid}-light`, fillOpacity: '0.300000012', fill: '#FFFFFF', xlinkHref: '#' + path3 })),
                React.createElement("g", { id: `${this.props.uid}-hat-front` },

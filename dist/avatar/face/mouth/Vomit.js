...
class Vomit extends React.Component {
    render() {
        ...
        return (React.createElement("g", { id: `${this.props.uid}-Mouth/Vomit`, transform: 'translate(2.000000, 52.000000)' },
            ...
            React.createElement("use", { id: `${this.props.uid}-Mouth`, fillOpacity: '0.699999988', fill: '#000000', fillRule: 'evenodd', transform: 'translate(54.000000, 21.499998) scale(1, -1) translate(-54.000000, -21.499998) ', xlinkHref: '#' + path1 }),
            React.createElement("rect", { id: `${this.props.uid}-Teeth`, fill: '#FFFFFF', fillRule: 'evenodd', mask: `url(#${mask1})`, x: '39', y: '0', width: '31', height: '16', rx: '5' }),
            React.createElement("g", { id: `${this.props.uid}-Vomit` },

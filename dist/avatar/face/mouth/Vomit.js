...
var Vomit = /** @class */ (function (_super) {
    ...
    Vomit.prototype.render = function () {
        ...
        var path2 = "".concat(this.props.uid, "-Mouth-path2");
        var mask1 = "".concat(this.props.uid, "-Mouth-mask1");
        var filter1 = "".concat(this.props.uid, "-Mouth-filter1");
        return (React.createElement("g", { id: "".concat(this.props.uid, "-Mouth/Vomit"), transform: 'translate(2.000000, 52.000000)' },
            ...
            React.createElement("use", { id: "".concat(this.props.uid, "-Mouth"), fillOpacity: '0.699999988', fill: '#000000', fillRule: 'evenodd', transform: 'translate(54.000000, 21.499998) scale(1, -1) translate(-54.000000, -21.499998) ', xlinkHref: '#' + path1 }),
            React.createElement("rect", { id: "".concat(this.props.uid, "-Teeth"), fill: '#FFFFFF', fillRule: 'evenodd', mask: "url(#".concat(mask1, ")"), x: '39', y: '0', width: '31', height: '16', rx: '5' }),
            React.createElement("g", { id: "".concat(this.props.uid, "-Vomit") },
                React.createElement("use", { fill: '#88C553', fillRule: 'evenodd', xlinkHref: '#' + path2 }),
                React.createElement("use", { fill: 'black', fillOpacity: '1', filter: "url(#".concat(filter1, ")"), xlinkHref: '#' + path2 }))));
    };

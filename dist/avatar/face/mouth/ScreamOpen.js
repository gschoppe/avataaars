...
class ScreamOpen extends React.Component {
    render() {
        ...
        return (React.createElement("g", { id: `${this.props.uid}-Mouth/Scream-Open`, transform: 'translate(2.000000, 52.000000)' },
            ...
            React.createElement("use", { id: `${this.props.uid}-Mouth`, fillOpacity: '0.699999988', fill: '#000000', fillRule: 'evenodd', transform: 'translate(54.000000, 26.999998) scale(1, -1) translate(-54.000000, -26.999998) ', xlinkHref: '#' + path1 }),
            ...
            React.createElement("g", { id: `${this.props.uid}-Tongue`, strokeWidth: '1', fillRule: 'evenodd', mask: `url(#${mask1})`, fill: '#FF4F6D' },

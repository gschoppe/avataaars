...
var GraphicShirt = /** @class */ (function (_super) {
    ...
    GraphicShirt.prototype.render = function () {
        ...
        return (React.createElement("g", { id: "".concat(this.props.uid, "-Clothing/Graphic-Shirt"), transform: 'translate(0.000000, 170.000000)' },
            ...
            React.createElement(Graphics_1.default, { uid: this.props.uid })));
    };

...
class ShirtScoopNeck extends React.Component {
    render() {
        const path1 = `${this.props.uid}-Clothing-path1`;
        const clothingColorMask = `${this.props.uid}-Clothing-Color-Mask`;
        return (React.createElement("g", { id: `${this.props.uid}-Clothing/Shirt-Scoop-Neck`, transform: 'translate(0.000000, 170.000000)' },
            ...
            React.createElement(Colors, { uid: this.props.uid })));
    }
}

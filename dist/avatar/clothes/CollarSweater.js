...
class CollarSweater extends React.Component {
    render() {
        const path1 = `${this.props.uid}-Clothing-path1`;
        const ClothingColorMask = `${this.props.uid}-Clothing-Color-Mask`;
        return (React.createElement("g", { id: `${this.props.uid}-Clothing/Collar-+-Sweater`, transform: 'translate(0.000000, 170.000000)' },

...
export default class BlazerShirt extends React.Component<Props> {
  ...
  render () {
    ...
    return (
      <g
        id={`${this.props.uid}-Clothing/Blazer-+-Shirt`}
        ...
        <g id={`${this.props.uid}-Blazer`} transform='translate(32.000000, 28.000000)'>
          <path
          ...
          <path
            ...
            id={`${this.props.uid}-Pocket-hanky`}
            fill='#E6E6E6'
          />
          <path

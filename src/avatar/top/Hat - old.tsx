...
export default class Hat extends React.Component<Props> {
  ...
  render () {
    ...
    const mask2 = `${this.props.uid}-top-mask-3`
    ...
    return (
      <g id={`${this.props.uid}-Top`} strokeWidth='1' fillRule='evenodd'>
        ...
        <g id={`${this.props.uid}-Top/Accesories/Hat`} mask={`url(#${mask1})`}>

...
export default class Wayfarers extends React.Component<Props> {
  ...
  render () {
    ...
    return (
      <g
        id={`${this.props.uid}-Top/Accessories/Wayfarers`}
        fill='none'
        ...
        <g
          id={`${this.props.uid}-Wayfarers`}
          filter={`url(#${filter1})`}
          transform='translate(7.000000, 7.000000)'>
          <g
            id={`${this.props.uid}-Shades`}
            transform='translate(10.795455, 2.928571)'
            fillRule='nonzero'>
            <g id={`${this.props.uid}-Shade-Left`}>
              <use
            ...
            <g id={`${this.props.uid}-Shade-Right`}>
              <use
                fillOpacity='0.700000048'
                fill='#000000'
                fillRule='evenodd'

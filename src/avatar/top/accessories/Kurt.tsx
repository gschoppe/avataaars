...
export default class Kurt extends React.Component<Props> {
  ...
  render () {
    ...
    return (
      <g
        id={`${this.props.uid}-Top/Accessories/Kurt`}
        fill='none'

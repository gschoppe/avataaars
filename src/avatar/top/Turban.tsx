  ...
  render () {
    ...
    return (
      <g id={`${this.props.uid}-Top`} strokeWidth='1' fillRule='evenodd'>
        ...
        <g id={`${this.props.uid}-Top/Accesories/Turban`} mask={`url(#${mask1})`}>
          <g transform='translate(-1.000000, 0.000000)'>
            <FacialHair uid={this.props.uid} />
            <g
              id={`${this.props.uid}-Turban-Behind`}
              strokeWidth='1'
              fillRule='evenodd'
            ...
            <g
              ...
              <g transform='translate(48.000000, 3.000000)'>
                ...
                <use id={`${this.props.uid}-Turban-Mask`} fill='#124C74' xlinkHref={'#' + path2} />
              ...
              <path
                ...
                id={`${this.props.uid}-Turban-Shadow`}
                fillOpacity='0.16'
                fill='#000000'
              />
            </g>

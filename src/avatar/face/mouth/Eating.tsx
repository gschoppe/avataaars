...
export default class Eating extends React.Component<Props> {
  ...
  render () {
    return (
      <g id={`${this.props.uid}-Mouth/Eating`} transform='translate(2.000000, 52.000000)'>
        <g
          ...
          <path
            ...
            id={`${this.props.uid}-Mouth-Path`}
          />
        </g>
        <circle
          id={`${this.props.uid}-Cheek-Left`}
          fillOpacity='0.2'
          fill='#FF4646'
          cx='17'
          cy='15'

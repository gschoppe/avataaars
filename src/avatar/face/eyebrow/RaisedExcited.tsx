...
export default class RaisedExcited extends React.Component<Props> {
  ...
  render () {
    return (
      <g id={`${this.props.uid}-Eyebrow/Outline/Raised-Excited`} fillOpacity='0.599999964'>
        <g id={`${this.props.uid}-Eyebrows`} transform='translate(12.000000, 0.000000)'>
          <path
            ...
            id={`${this.props.uid}-Eyebrow-Left`}
            fillRule='nonzero'
          />
          <path
            ...
            id={`${this.props.uid}-Eyebrow-Right`}
            fillRule='nonzero'
